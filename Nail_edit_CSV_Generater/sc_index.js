...
const main = async () => {
  ...
  const category_name = "2021年7月新色";
  const category_display_name = "2021年7月新色";
  const category_id = "8000"; //たぶん適当に番号をつけてく
  let counter = 286; //変換結果をNailProducts.csvの最後に追加するので、NailProducts.csvを開いて最後のindex番号を入れる
  let csv_product = "";
  let csv_category = "";
  let csv_ecurl = "";
